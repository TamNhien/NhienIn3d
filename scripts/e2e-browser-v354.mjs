...
if (!password) throw new Error("Thiếu ADMIN_PASSWORD trong biến môi trường hoặc file .env để chạy browser E2E v3.5.4");
...
try {
  ...
  if (health.phien_ban !== "v3.5.4") {
    throw new Error(`API đang chạy ${health.phien_ban || "không rõ version"}, không phải v3.5.4. Docker có thể vẫn dùng container/image cũ sau một lần build thất bại.`);
  }
  ...
  console.log("Browser E2E v3.5.4 PASS ✅");
