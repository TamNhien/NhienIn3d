...
const defaultFile = resolve(process.env.SYSTEM_BACKUP_DIR || join(root, "backups"), "recovery-evidence-bundle-v3290.json");
...
console.log("Recovery evidence v3.29.0 verification PASS ✅");
