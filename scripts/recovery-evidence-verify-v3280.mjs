...
const defaultFile = resolve(process.env.SYSTEM_BACKUP_DIR || join(root, "backups"), "recovery-evidence-bundle-v3280.json");
...
console.log("Recovery evidence v3.28.0 verification PASS ✅");
