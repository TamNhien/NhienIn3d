...
const defaultFile = resolve(process.env.SYSTEM_BACKUP_DIR || join(root, "backups"), "recovery-evidence-bundle-v3220.json");
...
console.log("Recovery evidence v3.22.0 verification PASS ✅");
