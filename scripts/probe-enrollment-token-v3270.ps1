...
try {
  ...
  $loginBody = @{ thu_dien_tu = $email; mat_khau = $password; trinh_duyet_hien_thi = "Probe Enrollment v3.27.0" } | ConvertTo-Json
  ...
  Write-Host "[Probe Enrollment v3.27.0] Token tạo thành công cho $AgentId@$Region/$NodeName" -ForegroundColor Green
