...
const defaultFile = resolve(process.env.SYSTEM_BACKUP_DIR || join(root, "backups"), "recovery-evidence-bundle-v3230.json");
...
console.log("Recovery evidence v3.23.0 verification PASS ✅");
