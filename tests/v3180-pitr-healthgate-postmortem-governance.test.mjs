...
test("v3.20.0 dong bo current version scripts CI va grouped verify", () => {
  ...
  assert.match(pkg.scripts["recovery:pitr"], /recovery-pitr-drill-v3210\.ps1/);
  ...
  assert.match(compose, /SYSTEM_SLO_PROBE_DESIRED_TARGET_VERSION: \${SYSTEM_SLO_PROBE_DESIRED_TARGET_VERSION:-3\.21\.0}/);
