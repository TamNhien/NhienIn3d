...
test("v3.6.4 health-version fix duoc giu khi nang patch tiep theo", () => {
  ...
  assert.match(pkg.version, /^(?:3\.6\.[4567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0|3\.19\.0|3\.20\.0|3\.20\.0)$/);
  assert.match(pkg.scripts["e2e:browser"], /^node scripts\/e2e-browser-v(?:36[4567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150|3160|3170|3180|3190|3200)\.mjs$/);
  assert.match(ci, /e2e-runtime-v(?:36[4567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150|3160|3170|3180|3190|3200)\.ps1/);
  assert.match(ci, /Browser E2E Admin HTTPS v(?:3\.6\.[4567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0|3\.19\.0|3\.20\.0)/);
