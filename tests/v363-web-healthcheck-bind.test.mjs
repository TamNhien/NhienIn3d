...
test("v3.6.3 healthcheck fix duoc giu khi nang patch tiep theo", () => {
  ...
  assert.match(root.version, /^(?:3\.6\.[34567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0)$/);
  assert.equal(api.version, root.version);
  assert.equal(web.version, root.version);
  assert.match(root.scripts["e2e:browser"], /^node scripts\/e2e-browser-v(?:36[34567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150)\.mjs$/);
  ...
  assert.match(ci, /e2e-runtime-v(?:36[34567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150)\.ps1/);
  assert.match(ci, /Browser E2E Admin HTTPS v(?:3\.6\.[34567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0)/);
});
