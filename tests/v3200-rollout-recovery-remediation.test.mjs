...
test("v3.20.0 dong bo version, current scripts, CI va grouped verify", () => {
  ...
  assert.match(pkg.scripts["recovery:drill"], /recovery-drill-v3270\.ps1/);
  ...
  assert.equal(pkg.scripts["recovery:evidence:keygen"], "node scripts/recovery-evidence-keygen-v3270.mjs");
