...
test("v3.20.0 dong bo version, current scripts, CI va grouped verify", () => {
  ...
  assert.equal(pkg.scripts["recovery:evidence"], "node scripts/recovery-evidence-v3240.mjs");
  assert.equal(pkg.scripts["recovery:evidence:keygen"], "node scripts/recovery-evidence-keygen-v3240.mjs");
