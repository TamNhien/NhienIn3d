...
test("version v3.28.0 dong bo root API va Web", () => {
  assert.equal(readFileSync("VERSION", "utf8").trim(), "3.28.0");
  assert.equal(docJson("package.json").version, "3.28.0");
  assert.equal(docJson("apps/api/package.json").version, "3.28.0");
  assert.equal(docJson("apps/web/package.json").version, "3.28.0");
});
