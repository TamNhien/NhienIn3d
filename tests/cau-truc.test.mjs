...
test("version v2.19.3 dong bo root API va Web", () => {
  assert.equal(readFileSync("VERSION", "utf8").trim(), "2.19.3");
  assert.equal(docJson("package.json").version, "2.19.3");
  assert.equal(docJson("apps/api/package.json").version, "2.19.3");
  assert.equal(docJson("apps/web/package.json").version, "2.19.3");
});
