...
test("v3.6.2 E2E va CI dung phien ban patch moi", () => {
  ...
  assert.match(root.scripts["e2e:browser"], /^node scripts\/e2e-browser-v(?:36[234567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150|3160|3170|3180|3190|3200|3220|3230)\.mjs$/);
  assert.match(runtime, /không phải v3\.6\.2/);
  assert.match(browser, /không phải v3\.6\.2/);
  assert.match(ci, /e2e-runtime-v(?:36[234567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150|3160|3170|3180|3190|3200|3220|3230)\.ps1/);
  assert.match(ci, /Browser E2E Admin HTTPS v(?:3\.6\.[234567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0|3\.19\.0|3\.20\.0|3\.23\.0)/);
});
