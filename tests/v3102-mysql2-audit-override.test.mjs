...
test("v3.11.0 dong bo Runtime Browser CI va health", () => {
  ...
  assert.equal(root.version, "3.16.0");
  assert.equal(root.scripts["e2e:browser"], "node scripts/e2e-browser-v3160.mjs");
  ...
  assert.match(ci, /Browser E2E Admin HTTPS v3\.16\.0/);
