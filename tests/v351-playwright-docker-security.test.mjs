...
test("v3.5.1 runtime va browser E2E chan container cu truoc khi kiem tra SLO", () => {
  ...
  assert.match(ci, /e2e-runtime-v(?:35[1234]|36[01234567]|37[012]|380|390|3100|3101|3102|3103|3104|3105|3110|3120|3130|3140|3150|3160|3170|3180|3190|3200|3220|3230)\.ps1/);
  assert.match(ci, /Browser E2E Admin HTTPS v(?:3\.5\.[1234]|3\.6\.[01234567]|3\.7\.[012]|3\.8\.0|3\.9\.0|3\.10\.[012345]|3\.11\.0|3\.12\.0|3\.13\.0|3\.14\.0|3\.15\.0|3\.19\.0|3\.20\.0|3\.23\.0)/);
});
