...
export const luuIncidentPostmortemAdmin = (chu_ky: string, payload: Omit<IncidentPostmortemAdmin, "incident_id" | "status" | "timeline_snapshot" | "updated_at" | "updated_by">) => goi<IncidentPostmortemAdmin>(`/quan-tri/he-thong/su-co/${encodeURIComponent(chu_ky)}/postmortem`, { method: "POST", body: JSON.stringify(payload) });
