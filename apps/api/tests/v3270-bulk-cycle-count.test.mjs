...
test("v3.27.0 API co preview file kiem ke, atomic apply va Excel doi soat", () => {
  ...
  assert.match(controller, /kiem_tra_tep_kiem_ke_kho_v3280/);
  assert.match(controller, /xuat_kiem_ke_kho_excel_v3280/);
  assert.match(controller, /ap_dung_kiem_ke_kho_v3280/);
