...
test("v3.19.0 API runtime co health gate PITR governance va version", () => {
  ...
  assert.match(service, /trang_thai_ops_v3190/);
...
test("v3.19.0 API health gate khong co remote code execution", () => {
  const service = read("../src/quan-tri/quan-tri.service.ts");
  const start = service.indexOf("private async auto_rollback_probe_desired_state_v3190");
