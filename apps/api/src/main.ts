...
async function khoi_dong() {
  ...
  const cau_hinh_openapi = new DocumentBuilder().setTitle("NhienIn3d API").setDescription("API v3.15.0 cho cửa hàng sản phẩm in 3D NhienIn3d").setVersion("3.15.0").addCookieAuth("nhienin3d_phien").build();
