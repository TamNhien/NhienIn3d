...
export class QuanTriController {
  ...
  @Get("he-thong/ops/runtime") ops_runtime() { return this.service.trang_thai_ops_v3270(); }
  @Get("he-thong/ops/probe-desired-state") probe_desired_state() { return this.service.lay_probe_desired_state_v3170(); }
  @Post("he-thong/ops/probe-desired-state") cap_nhat_probe_desired_state(@Req() req: YeuCauCoNguoiDung, @Body() dto: CapNhatProbeDesiredStateDto) { return this.service.cap_nhat_probe_desired_state_v3270(req.nguoi_dung_xac_thuc!, dto); }
  @Get("he-thong/ops/probe-desired-state/proposal") probe_rollout_proposal_v3260() { return this.service.lay_probe_rollout_proposal_v3270(); }
  @Post("he-thong/ops/probe-desired-state/proposal/approve") approve_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.approve_probe_rollout_v3270(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/reject") reject_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.reject_probe_rollout_v3270(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/cancel") cancel_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.cancel_probe_rollout_v3270(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  ...
  @Get("he-thong/ops/recovery/evidence-bundle") recovery_evidence_bundle_v3260() { return this.service.xuat_recovery_evidence_bundle_v3270(); }
  @Get("he-thong/ops/recovery/evidence-verify") recovery_evidence_verify_v3260() { return this.service.verify_recovery_evidence_v3270(); }
  ...
  @Get("phan-ca/xung-dot") phan_ca_xung_dot_v3260(@Query("tu_ngay") tu_ngay?: string, @Query("den_ngay") den_ngay?: string) { return this.service.danh_sach_xung_dot_phan_ca_v3270(tu_ngay, den_ngay); }
  ...
  @Get("don-hang/hoan-tien-can-xu-ly") hoan_tien_can_xu_ly_v3260() { return this.service.danh_sach_hoan_tien_can_xu_ly_v3270(); }
  @Get("don-hang/hoan-tien-can-xu-ly/excel") hoan_tien_can_xu_ly_excel_v3260() { return this.service.xuat_hoan_tien_can_xu_ly_excel_v3270(); }
  ...
  @Post("don-hang/:id/xac-nhan-hoan-tien") xac_nhan_hoan_tien_v3260(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: XacNhanHoanTienDto) { return this.service.xac_nhan_hoan_tien_don_hang_v3270(req.nguoi_dung_xac_thuc!, id, dto.ghi_chu); }
  ...
  @Get("kho/goi-y-nhap") goi_y_nhap_kho_v3260() { return this.service.goi_y_nhap_kho_v3270(); }
  @Get("kho/goi-y-nhap/excel") goi_y_nhap_kho_excel_v3260() { return this.service.xuat_goi_y_nhap_kho_excel_v3270(); }
  @Post("kho/kiem-ke/kiem-tra") kiem_tra_kiem_ke_kho_v3260(@Body() dto: KiemKeKhoV3260Dto) { return this.service.kiem_tra_kiem_ke_kho_v3270(dto); }
  @Post("kho/kiem-ke/ap-dung") ap_dung_kiem_ke_kho_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: KiemKeKhoV3260Dto) { return this.service.ap_dung_kiem_ke_kho_v3270(req.nguoi_dung_xac_thuc!, dto); }
  @Post("kho/kiem-ke/import/kiem-tra") kiem_tra_tep_kiem_ke_kho_v3270(@Body() dto: KiemTraTepNhapKhoDto) { return this.service.kiem_tra_tep_kiem_ke_kho_v3270(dto); }
  @Post("kho/kiem-ke/excel") xuat_kiem_ke_kho_excel_v3270(@Body() dto: KiemKeKhoV3260Dto) { return this.service.xuat_kiem_ke_kho_excel_v3270(dto); }
