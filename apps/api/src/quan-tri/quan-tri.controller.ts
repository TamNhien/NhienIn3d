...
export class QuanTriController {
  ...
  @Get("he-thong/ops/runtime") ops_runtime() { return this.service.trang_thai_ops_v3230(); }
  @Get("he-thong/ops/probe-desired-state") probe_desired_state() { return this.service.lay_probe_desired_state_v3170(); }
  @Post("he-thong/ops/probe-desired-state") cap_nhat_probe_desired_state(@Req() req: YeuCauCoNguoiDung, @Body() dto: CapNhatProbeDesiredStateDto) { return this.service.cap_nhat_probe_desired_state_v3230(req.nguoi_dung_xac_thuc!, dto); }
  @Get("he-thong/ops/probe-desired-state/proposal") probe_rollout_proposal_v3230() { return this.service.lay_probe_rollout_proposal_v3230(); }
  @Post("he-thong/ops/probe-desired-state/proposal/approve") approve_probe_rollout_v3230(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.approve_probe_rollout_v3230(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/reject") reject_probe_rollout_v3230(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.reject_probe_rollout_v3230(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/cancel") cancel_probe_rollout_v3230(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.cancel_probe_rollout_v3230(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  ...
  @Get("he-thong/ops/recovery/evidence-bundle") recovery_evidence_bundle_v3230() { return this.service.xuat_recovery_evidence_bundle_v3230(); }
  @Get("he-thong/ops/recovery/evidence-verify") recovery_evidence_verify_v3230() { return this.service.verify_recovery_evidence_v3230(); }
  @Get("he-thong/ops/remediation/excel") remediation_excel_v3230() { return this.service.xuat_remediation_backlog_excel_v3230(); }
  @Post("he-thong/ops/remediation/escalate") remediation_escalate_v3230() { return this.service.kiem_tra_remediation_escalation_v3230(true); }
  @Post("he-thong/ops/remediation/acknowledge") remediation_ack_v3230(@Req() req: YeuCauCoNguoiDung, @Body() dto: AcknowledgeRemediationV3210Dto) { return this.service.acknowledge_remediation_v3230(req.nguoi_dung_xac_thuc!, dto.service, dto.note, dto.snooze_hours); }
