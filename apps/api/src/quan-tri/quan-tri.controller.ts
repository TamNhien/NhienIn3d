...
import { XacNhanHoanTienDto } from "./dto/xac-nhan-hoan-tien.dto.js";
...
import { KiemKeKhoV3260Dto } from "./dto/kiem-ke-kho-v3260.dto.js";
import { TaoDonMuaHangV3280Dto, CapNhatTrangThaiDonMuaV3280Dto } from "./dto/don-mua-hang-v3280.dto.js";
import { TaoPhienKiemKeV3280Dto } from "./dto/phien-kiem-ke-v3280.dto.js";
import { TaoYeuCauDoiTraV3290Dto, NhanHangDoiTraV3290Dto, XacNhanHoanTienMotPhanV3290Dto, CapNhatTrangThaiDoiTraV3290Dto } from "./dto/doi-tra-v3290.dto.js";
...
import { AcknowledgeRemediationV3210Dto, DecideProbeRolloutV3210Dto } from "./dto/ops-v3210.dto.js";
...
export class QuanTriController {
  ...
  @Get("he-thong/ops/runtime") ops_runtime() { return this.service.trang_thai_ops_v3290(); }
  @Get("he-thong/ops/probe-desired-state") probe_desired_state() { return this.service.lay_probe_desired_state_v3170(); }
  @Post("he-thong/ops/probe-desired-state") cap_nhat_probe_desired_state(@Req() req: YeuCauCoNguoiDung, @Body() dto: CapNhatProbeDesiredStateDto) { return this.service.cap_nhat_probe_desired_state_v3290(req.nguoi_dung_xac_thuc!, dto); }
  @Get("he-thong/ops/probe-desired-state/proposal") probe_rollout_proposal_v3260() { return this.service.lay_probe_rollout_proposal_v3290(); }
  @Post("he-thong/ops/probe-desired-state/proposal/approve") approve_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.approve_probe_rollout_v3290(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/reject") reject_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.reject_probe_rollout_v3290(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  @Post("he-thong/ops/probe-desired-state/proposal/cancel") cancel_probe_rollout_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: DecideProbeRolloutV3210Dto) { return this.service.cancel_probe_rollout_v3290(req.nguoi_dung_xac_thuc!, dto.proposal_id, dto.note); }
  ...
  @Get("he-thong/ops/recovery/evidence-bundle") recovery_evidence_bundle_v3260() { return this.service.xuat_recovery_evidence_bundle_v3290(); }
  @Get("he-thong/ops/recovery/evidence-verify") recovery_evidence_verify_v3260() { return this.service.verify_recovery_evidence_v3290(); }
  @Get("he-thong/ops/remediation/excel") remediation_excel_v3240() { return this.service.xuat_remediation_backlog_excel_v3240(); }
  @Post("he-thong/ops/remediation/escalate") remediation_escalate_v3240() { return this.service.kiem_tra_remediation_escalation_v3240(true); }
  @Post("he-thong/ops/remediation/acknowledge") remediation_ack_v3240(@Req() req: YeuCauCoNguoiDung, @Body() dto: AcknowledgeRemediationV3210Dto) { return this.service.acknowledge_remediation_v3240(req.nguoi_dung_xac_thuc!, dto.service, dto.note, dto.snooze_hours); }
  ...
  @Get("phan-ca/xung-dot") phan_ca_xung_dot_v3260(@Query("tu_ngay") tu_ngay?: string, @Query("den_ngay") den_ngay?: string) { return this.service.danh_sach_xung_dot_phan_ca_v3290(tu_ngay, den_ngay); }
  ...
  @Get("don-hang/hoan-tien-can-xu-ly") hoan_tien_can_xu_ly_v3260() { return this.service.danh_sach_hoan_tien_can_xu_ly_v3290(); }
  @Get("don-hang/hoan-tien-can-xu-ly/excel") hoan_tien_can_xu_ly_excel_v3260() { return this.service.xuat_hoan_tien_can_xu_ly_excel_v3290(); }
  @Get("doi-tra") doi_tra_v3290(@Query("don_hang_id") don_hang_id?: string) { return this.service.danh_sach_doi_tra_v3290(don_hang_id); }
  @Get("doi-tra/excel") doi_tra_excel_v3290() { return this.service.xuat_doi_tra_excel_v3290(); }
  @Post("don-hang/:id/doi-tra") tao_doi_tra_v3290(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: TaoYeuCauDoiTraV3290Dto) { return this.service.tao_yeu_cau_doi_tra_v3290(req.nguoi_dung_xac_thuc!, id, dto); }
  @Post("doi-tra/:id/trang-thai") cap_nhat_doi_tra_v3290(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: CapNhatTrangThaiDoiTraV3290Dto) { return this.service.cap_nhat_trang_thai_doi_tra_v3290(req.nguoi_dung_xac_thuc!, id, dto.trang_thai, dto.ghi_chu); }
  @Post("doi-tra/:id/nhan-hang") nhan_hang_doi_tra_v3290(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: NhanHangDoiTraV3290Dto) { return this.service.nhan_hang_doi_tra_v3290(req.nguoi_dung_xac_thuc!, id, dto); }
  @Post("doi-tra/:id/hoan-tien") hoan_tien_mot_phan_v3290(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: XacNhanHoanTienMotPhanV3290Dto) { return this.service.xac_nhan_hoan_tien_mot_phan_v3290(req.nguoi_dung_xac_thuc!, id, dto.so_tien, dto.ghi_chu); }
  ...
  @Post("don-hang/:id/xac-nhan-hoan-tien") xac_nhan_hoan_tien_v3260(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: XacNhanHoanTienDto) { return this.service.xac_nhan_hoan_tien_don_hang_v3290(req.nguoi_dung_xac_thuc!, id, dto.ghi_chu); }
  ...
  @Get("kho/goi-y-nhap") goi_y_nhap_kho_v3260() { return this.service.goi_y_nhap_kho_v3290(); }
  @Get("kho/goi-y-nhap/excel") goi_y_nhap_kho_excel_v3260() { return this.service.xuat_goi_y_nhap_kho_excel_v3290(); }
  @Post("kho/kiem-ke/kiem-tra") kiem_tra_kiem_ke_kho_v3260(@Body() dto: KiemKeKhoV3260Dto) { return this.service.kiem_tra_kiem_ke_kho_v3290(dto); }
  @Post("kho/kiem-ke/ap-dung") ap_dung_kiem_ke_kho_v3260(@Req() req: YeuCauCoNguoiDung, @Body() dto: KiemKeKhoV3260Dto) { return this.service.ap_dung_kiem_ke_kho_v3290(req.nguoi_dung_xac_thuc!, dto); }
  @Post("kho/kiem-ke/import/kiem-tra") kiem_tra_tep_kiem_ke_kho_v3280(@Body() dto: KiemTraTepNhapKhoDto) { return this.service.kiem_tra_tep_kiem_ke_kho_v3290(dto); }
  @Post("kho/kiem-ke/excel") xuat_kiem_ke_kho_excel_v3280(@Body() dto: KiemKeKhoV3260Dto) { return this.service.xuat_kiem_ke_kho_excel_v3290(dto); }
  @Get("kho/don-mua") don_mua_v3280(@Query("trang_thai") trang_thai?: string) { return this.service.danh_sach_don_mua_v3280(trang_thai); }
  @Post("kho/don-mua") tao_don_mua_v3280(@Req() req: YeuCauCoNguoiDung, @Body() dto: TaoDonMuaHangV3280Dto) { return this.service.tao_don_mua_v3280(req.nguoi_dung_xac_thuc!, dto); }
  @Post("kho/don-mua/:id/trang-thai") cap_nhat_don_mua_v3280(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string, @Body() dto: CapNhatTrangThaiDonMuaV3280Dto) { return this.service.cap_nhat_trang_thai_don_mua_v3280(req.nguoi_dung_xac_thuc!, id, dto.trang_thai, dto.ghi_chu); }
  @Get("kho/don-mua-excel") don_mua_excel_v3280() { return this.service.xuat_don_mua_excel_v3280(); }
  @Get("kho/kiem-ke/phien") phien_kiem_ke_v3280() { return this.service.danh_sach_phien_kiem_ke_v3280(); }
  @Post("kho/kiem-ke/phien") tao_phien_kiem_ke_v3280(@Req() req: YeuCauCoNguoiDung, @Body() dto: TaoPhienKiemKeV3280Dto) { return this.service.tao_phien_kiem_ke_v3280(req.nguoi_dung_xac_thuc!, dto); }
  @Post("kho/kiem-ke/phien/:id/gui-duyet") gui_duyet_phien_kiem_ke_v3280(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string) { return this.service.gui_duyet_phien_kiem_ke_v3280(req.nguoi_dung_xac_thuc!, id); }
  @Post("kho/kiem-ke/phien/:id/duyet-ap-dung") duyet_phien_kiem_ke_v3280(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string) { return this.service.duyet_ap_dung_phien_kiem_ke_v3280(req.nguoi_dung_xac_thuc!, id); }
  @Post("kho/kiem-ke/phien/:id/huy") huy_phien_kiem_ke_v3280(@Req() req: YeuCauCoNguoiDung, @Param("id") id: string) { return this.service.huy_phien_kiem_ke_v3280(req.nguoi_dung_xac_thuc!, id); }
  ...
  @Get("bao-cao/loi-nhuan/excel") bao_cao_loi_nhuan_v3290() { return this.service.xuat_loi_nhuan_excel_v3290(); }
